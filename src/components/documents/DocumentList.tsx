...
const DocumentList = ({ dealId, canDownload = true, canDelete = false, section }: DocumentListProps) => {
        ...
        <CardHeader>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Select value={selectedTag} onValueChange={setSelectedTag}>
              <SelectTrigger className="w-full sm:w-48 bg-background border-[#D4AF37]/30">
              ...
              <table className="w-full">
                ...
                <tbody>
                  {filteredDocuments.map((document) => (
                    <tr key={document.id} className="border-b border-[#D4AF37]/10 hover:bg-muted/5">
                      <td className="p-4">
