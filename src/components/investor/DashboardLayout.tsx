...
const DashboardLayout = ({ children, activeTab = 'dashboard', onTabChange, breadcrumbs }: DashboardLayoutProps) => {
  ...
  const isNavItemActive = (path: string) => {
    ...
    if (path === '/access-requests' || path === '/dashboard/access-requests') {
      return location.pathname.includes('access-requests');
    }
    if (path === '/ndas' || path === '/dashboard/ndas') {
      ...
      <div className="flex-1 lg:ml-64 overflow-auto">
        ...
        <div className="bg-gradient-to-b from-[#0A0F0F] to-[#1A1F2E] border-b border-[#D4AF37]/30 p-4 lg:p-6 sticky top-0 z-30">
          <div className="flex justify-between items-center">
            {/* Breadcrumbs - Hidden on mobile due to hamburger menu */}
