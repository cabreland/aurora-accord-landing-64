    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
      {documents.map((doc) => {
        ...
        return (
          ...
          >
            {/* File Preview Area */}
            <div className={cn('relative h-32 flex items-center justify-center', fileIconConfig.bgColor)}>
            ...
            {/* File Info */}
            <div className="p-3">
              <h4 className="font-medium text-sm text-foreground truncate" title={doc.file_name}>
                {doc.file_name}
              </h4>
