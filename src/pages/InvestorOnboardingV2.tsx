...
const InvestorOnboardingV2 = () => {
  ...
  useEffect(() => {
    const handleMessage = (event: MessageEvent) => {
      if (
        event.data === 'ghl-form-submit' ||
        event.data?.type === 'formSubmitted' ||
        event.data?.type === 'submitted' ||
        (Array.isArray(event.data) && event.data.includes('form-submitted')) ||
        (typeof event.data === 'string' && (event.data.includes('thank') || event.data.includes('success')))
      ) {
  ...
  return (
    <div className="min-h-screen bg-[hsl(var(--portal-bg))]">
      <div className="container mx-auto px-4 py-8">
        ...
        {formCompleted ? (
          <div className="max-w-2xl mx-auto bg-[hsl(var(--portal-card))] rounded-lg p-8 text-center">
          ...
          <>
            <div className="max-w-4xl mx-auto">
              <iframe
                src="https://api.leadconnectorhq.com/widget/form/oQ4i4FTGKhLr6hX9Azse"
                className="w-full h-[800px] border-0"
                id="inline-oQ4i4FTGKhLr6hX9Azse" 
                ...
                data-form-name="EBB Buyer Questionnaire"
                data-height="706"
                data-layout-iframe-id="inline-oQ4i4FTGKhLr6hX9Azse"
                data-form-id="oQ4i4FTGKhLr6hX9Azse"
                title="EBB Buyer Questionnaire"
                onLoad={(e) => {
